...
class LoginBackgroundPatternPainter extends CustomPainter {
  final bool isDark;

  final double animationValue;

  const LoginBackgroundPatternPainter({
  ...
  @override
  bool shouldRepaint(covariant LoginBackgroundPatternPainter oldDelegate) {
